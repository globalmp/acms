...
?>
    ...
    <?= Html::a('Ко всем клиентам',['orders/index'], ['class' => 'btn btn-w-md btn-success', 'name' => 'add-button']) ?>
</div>
                            <h3><?= $data['title']; ?></h3>
                            <small>
                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            <?php
                                $count = app\models\Links::find()->where(['action'=>'clients/read','type'=>'messages','row_id'=>Yii::$app->request->get('id')])->count();
                            ?>
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane <?php echo ((!@Yii::$app->request->get('openTab'))?"active":""); ?>">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="small">Дата добавления клиента</div>
                                                ...
                                                <div class="col-lg-9">
                                                        <div class="panel panel-c-white" style="margin-bottom:0px;">
                                                            <div class="panel-body" style="margin-bottom:0px; padding:12px">
                                                                Новый комментарий к карточке клиента
                                                            </div>
                                                        </div>
                                                </div>
                                            </div>
