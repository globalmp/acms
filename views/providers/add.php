...
<div class="row">
	...
	<?= Html::a('Ко всем поставщикам',['providers/index'], ['class' => 'btn btn-w-md btn-success', 'name' => 'add-button']) ?>
                            ...
                            <small>
                                Вы можете добавить нового поставщика в базу, заполнив форму данных ниже. Будьте внимательный при заполнении данных.
                            </small>
...
<div class="form-group col-lg-3">
<label>Дата добавления поставщика</label>
<?php 
...
<div class="form-group col-lg-3">
<label>Состояние поставщика</label>
...
<?= Html::submitButton('Добавить поставщика', ['class' => 'btn btn-w-md btn-success', 'name' => 'add-button']) ?>
